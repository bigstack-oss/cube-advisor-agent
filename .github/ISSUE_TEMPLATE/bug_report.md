...
> **Bigstack-internal work only** — external contributors can ignore this section;
> the handbook it refers to is a private repository.

- [ ] **Handbook knowledge update** — land the durable, team-readable knowledge from this
      work into the bigstack-handbook cube-ai-advisor kb (`kb/cube-ai-advisor/…`) via
